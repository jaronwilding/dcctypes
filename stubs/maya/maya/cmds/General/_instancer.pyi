...
def instancer(addObject: bool = ..., cycle: str = ..., cycleStep: float = ..., cycleStepUnits: str = ..., index: int = ..., levelOfDetail: str = ..., name: str = ..., object: str = ..., objectPosition: str = ..., objectRotation: str = ..., objectScale: str = ..., pointDataSource: bool = ..., rotationOrder: str = ..., rotationUnits: str = ..., valueName: str = ..., query: bool = ...) -> str:
    """instancer is undoable, queryable, and editable.
    ...
    """
@overload #Overload for instancer in ['query']
def instancer(a: bool = ..., c: str = ..., cs: float = ..., csu: str = ..., i: int = ..., lod: str = ..., n: str = ..., obj: str = ..., op: str = ..., os: str = ..., pds: bool = ..., ro: str = ..., ru: str = ..., vn: str = ..., q: bool = ...) -> str:
    """instancer is undoable, queryable, and editable.
...
def instancer(addObject: bool = ..., cycle: str = ..., cycleStep: float = ..., cycleStepUnits: str = ..., levelOfDetail: str = ..., name: str = ..., object: str = ..., removeObject: bool = ..., rotationOrder: str = ..., rotationUnits: str = ..., edit: bool = ...) -> str:
    """instancer is undoable, queryable, and editable.
    ...
    """
@overload #Overload for instancer in ['edit']
def instancer(a: bool = ..., c: str = ..., cs: float = ..., csu: str = ..., lod: str = ..., n: str = ..., obj: str = ..., rm: bool = ..., ro: str = ..., ru: str = ..., e: bool = ...) -> str:
    """instancer is undoable, queryable, and editable.
    ...
    """
@overload #Overload for instancer in ['edit']
def instancer(addObject: bool = ..., a: bool = ..., cycle: str = ..., c: str = ..., cycleStep: float = ..., cs: float = ..., cycleStepUnits: str = ..., csu: str = ..., levelOfDetail: str = ..., lod: str = ..., name: str = ..., n: str = ..., object: str = ..., obj: str = ..., removeObject: bool = ..., rm: bool = ..., rotationOrder: str = ..., ro: str = ..., rotationUnits: str = ..., ru: str = ..., edit: bool = ..., e: bool = ...) -> str:
    """instancer is undoable, queryable, and editable.
