...
def containerTemplate(addBindingSet: str = ..., addView: str = ..., allKeyable: bool = ..., attribute: str = ..., attributeList: str = ..., baseName: str = ..., bindingSetList: str = ..., childAnchor: bool = ..., delete: bool = ..., expandCompounds: bool = ..., fileName: str = ..., force: bool = ..., fromContainer: str = ..., fromSelection: bool = ..., layoutMode: int = ..., parentAnchor: bool = ..., publishedNodeList: str = ..., removeBindingSet: str = ..., removeView: str = ..., rootTransform: bool = ..., save: bool = ..., silent: bool = ..., unload: bool = ..., updateBindingSet: str = ..., useHierarchy: bool = ..., viewList: str = ...) -> None:
    ...
    """
@overload #Overload for containerTemplate in ['create']
def containerTemplate(abs: str = ..., av: str = ..., ak: bool = ..., at: str = ..., al: str = ..., bn: str = ..., bsl: str = ..., can: bool = ..., d: bool = ..., ec: bool = ..., fn: str = ..., f: bool = ..., fc: str = ..., fs: bool = ..., lm: int = ..., pan: bool = ..., pnl: str = ..., rbs: str = ..., rv: str = ..., rtn: bool = ..., s: bool = ..., si: bool = ..., u: bool = ..., ubs: str = ..., uh: bool = ..., vl: str = ...) -> None:
    """containerTemplate is NOT undoable, queryable, and editable.
...
def containerTemplate(attributeList: str = ..., baseName: str = ..., bindingSetList: str = ..., childAnchor: bool = ..., exists: bool = ..., fileName: str = ..., matchFile: str = ..., matchName: str = ..., parentAnchor: bool = ..., publishedNodeList: str = ..., rootTransform: bool = ..., searchPath: str = ..., silent: bool = ..., templateList: str = ..., viewList: str = ..., query: bool = ...) -> None:
    """containerTemplate is NOT undoable, queryable, and editable.
    ...
    """
@overload #Overload for containerTemplate in ['query']
def containerTemplate(al: str = ..., bn: str = ..., bsl: str = ..., can: bool = ..., ex: bool = ..., fn: str = ..., mf: str = ..., mn: str = ..., pan: bool = ..., pnl: str = ..., rtn: bool = ..., sp: str = ..., si: bool = ..., tl: str = ..., vl: str = ..., q: bool = ...) -> None:
    """containerTemplate is NOT undoable, queryable, and editable.
    ...
    """
@overload #Overload for containerTemplate in ['query']
def containerTemplate(attributeList: str = ..., al: str = ..., baseName: str = ..., bn: str = ..., bindingSetList: str = ..., bsl: str = ..., childAnchor: bool = ..., can: bool = ..., exists: bool = ..., ex: bool = ..., fileName: str = ..., fn: str = ..., matchFile: str = ..., mf: str = ..., matchName: str = ..., mn: str = ..., parentAnchor: bool = ..., pan: bool = ..., publishedNodeList: str = ..., pnl: str = ..., rootTransform: bool = ..., rtn: bool = ..., searchPath: str = ..., sp: str = ..., silent: bool = ..., si: bool = ..., templateList: str = ..., tl: str = ..., viewList: str = ..., vl: str = ..., query: bool = ..., q: bool = ...) -> None:
    """containerTemplate is NOT undoable, queryable, and editable.
...
def containerTemplate(addBindingSet: str = ..., addNames: bool = ..., addView: str = ..., allKeyable: bool = ..., attribute: str = ..., attributeList: str = ..., expandCompounds: bool = ..., fromSelection: bool = ..., publishedNodeList: str = ..., removeBindingSet: str = ..., removeView: str = ..., searchPath: str = ..., silent: bool = ..., updateBindingSet: str = ..., useHierarchy: bool = ..., edit: bool = ...) -> None:
    """containerTemplate is NOT undoable, queryable, and editable.
    ...
    """
@overload #Overload for containerTemplate in ['edit']
def containerTemplate(abs: str = ..., an: bool = ..., av: str = ..., ak: bool = ..., at: str = ..., al: str = ..., ec: bool = ..., fs: bool = ..., pnl: str = ..., rbs: str = ..., rv: str = ..., sp: str = ..., si: bool = ..., ubs: str = ..., uh: bool = ..., e: bool = ...) -> None:
    """containerTemplate is NOT undoable, queryable, and editable.
    ...
    """
@overload #Overload for containerTemplate in ['edit']
def containerTemplate(addBindingSet: str = ..., abs: str = ..., addNames: bool = ..., an: bool = ..., addView: str = ..., av: str = ..., allKeyable: bool = ..., ak: bool = ..., attribute: str = ..., at: str = ..., attributeList: str = ..., al: str = ..., expandCompounds: bool = ..., ec: bool = ..., fromSelection: bool = ..., fs: bool = ..., publishedNodeList: str = ..., pnl: str = ..., removeBindingSet: str = ..., rbs: str = ..., removeView: str = ..., rv: str = ..., searchPath: str = ..., sp: str = ..., silent: bool = ..., si: bool = ..., updateBindingSet: str = ..., ubs: str = ..., useHierarchy: bool = ..., uh: bool = ..., edit: bool = ..., e: bool = ...) -> None:
    """containerTemplate is NOT undoable, queryable, and editable.
