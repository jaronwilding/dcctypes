...
def partition([string] [string...]: [string] [string...], render: bool = ..., re: bool = ..., query: bool = ..., q: bool = ...) -> str:
    ...
    - Args:
        ...
        - query (q): Query mode flag
    """
@overload #Overload for partition in ['edit']
def partition([string] [string...]: [string] [string...], render: bool = ..., edit: bool = ...) -> str:
    """partition is undoable, queryable, and editable.
    ...
    """
@overload #Overload for partition in ['edit']
def partition([string] [string...]: [string] [string...], re: bool = ..., e: bool = ...) -> str:
    """partition is undoable, queryable, and editable.
    ...
    """
@overload #Overload for partition in ['edit']
def partition([string] [string...]: [string] [string...], render: bool = ..., re: bool = ..., edit: bool = ..., e: bool = ...) -> str:
    """partition is undoable, queryable, and editable.
