...
def assembly(active: str = ..., activeLabel: str = ..., createOptionBoxProc: script = ..., defaultType: str = ..., label: str = ..., listRepTypesProc: script = ..., name: str = ..., postCreateUIProc: script = ..., repLabel: str = ..., repPostCreateUIProc: str = ..., repPreCreateUIProc: str = ..., repTypeLabelProc: script = ..., type: str = ...) -> None:
    ...
    """
@overload #Overload for assembly in ['create']
def assembly(a: str = ..., al: str = ..., cob: script = ..., dt: str = ..., lbl: str = ..., lrp: script = ..., n: str = ..., aoc: script = ..., rl: str = ..., poc: str = ..., pec: str = ..., rtp: script = ..., typ: str = ...) -> None:
    """assembly is undoable, queryable, and editable.
    ...
    """
@overload #Overload for assembly in ['create']
def assembly(active: str = ..., a: str = ..., activeLabel: str = ..., al: str = ..., createOptionBoxProc: script = ..., cob: script = ..., defaultType: str = ..., dt: str = ..., label: str = ..., lbl: str = ..., listRepTypesProc: script = ..., lrp: script = ..., name: str = ..., n: str = ..., postCreateUIProc: script = ..., aoc: script = ..., repLabel: str = ..., rl: str = ..., repPostCreateUIProc: str = ..., poc: str = ..., repPreCreateUIProc: str = ..., pec: str = ..., repTypeLabelProc: script = ..., rtp: script = ..., type: str = ..., typ: str = ...) -> None:
    """assembly is undoable, queryable, and editable.
