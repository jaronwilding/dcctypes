...
def softSelect(compressUndo: int = ..., enableFalseColor: int = ..., softSelectColorCurve: str = ..., softSelectCurve: str = ..., softSelectDistance: float = ..., softSelectEnabled: int = ..., softSelectFalloff: int = ..., softSelectUVDistance: float = ..., query: bool = ...) -> None:
    """softSelect is undoable, queryable, and editable.
    ...
    """
@overload #Overload for softSelect in ['query']
def softSelect(cu: int = ..., efc: int = ..., scc: str = ..., ssc: str = ..., ssd: float = ..., sse: int = ..., ssf: int = ..., sud: float = ..., q: bool = ...) -> None:
    """softSelect is undoable, queryable, and editable.
    ...
    """
@overload #Overload for softSelect in ['query']
def softSelect(compressUndo: int = ..., cu: int = ..., enableFalseColor: int = ..., efc: int = ..., softSelectColorCurve: str = ..., scc: str = ..., softSelectCurve: str = ..., ssc: str = ..., softSelectDistance: float = ..., ssd: float = ..., softSelectEnabled: int = ..., sse: int = ..., softSelectFalloff: int = ..., ssf: int = ..., softSelectUVDistance: float = ..., sud: float = ..., query: bool = ..., q: bool = ...) -> None:
    """softSelect is undoable, queryable, and editable.
