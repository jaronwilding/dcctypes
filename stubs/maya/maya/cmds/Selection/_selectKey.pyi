...
def selectKey([targetList]: [targetList], addTo: bool = ..., add: bool = ..., animation: str = ..., an: str = ..., attribute: str = ..., at: str = ..., clear: bool = ..., cl: bool = ..., controlPoints: bool = ..., cp: bool = ..., float: floatrange = ..., f: floatrange = ..., hierarchy: str = ..., hi: str = ..., inTangent: bool = ..., it: bool = ..., includeUpperBound: bool = ..., iub: bool = ..., index: int = ..., keyframe: bool = ..., k: bool = ..., outTangent: bool = ..., ot: bool = ..., remove: bool = ..., rm: bool = ..., replace: bool = ..., r: bool = ..., shape: bool = ..., s: bool = ..., time: timerange = ..., t: timerange = ..., toggle: bool = ..., tgl: bool = ..., unsnappedKeys: float = ..., uk: float = ...) -> int:
    ...
    * objects: Only act on specified objects. If there are no objects specified, don't do anything.
    ...
    - Args:
        ...
        - unsnappedKeys (uk): Select only keys that have times that are not a multiple of the specified numeric value.
    """
@overload #Overload for selectKey in ['query']
def selectKey([targetList]: [targetList], attribute: str = ..., float: floatrange = ..., index: int = ..., time: timerange = ..., query: bool = ...) -> int:
    """selectKey is undoable, NOT queryable, and NOT editable.
    ...
    * objects: Only act on specified objects. If there are no objects specified, don't do anything.
    ...
    """
@overload #Overload for selectKey in ['query']
def selectKey([targetList]: [targetList], at: str = ..., f: floatrange = ..., t: timerange = ..., q: bool = ...) -> int:
    """selectKey is undoable, NOT queryable, and NOT editable.
    ...
    * objects: Only act on specified objects. If there are no objects specified, don't do anything.
    ...
    """
@overload #Overload for selectKey in ['query']
def selectKey([targetList]: [targetList], attribute: str = ..., at: str = ..., float: floatrange = ..., f: floatrange = ..., index: int = ..., time: timerange = ..., t: timerange = ..., query: bool = ..., q: bool = ...) -> int:
    """selectKey is undoable, NOT queryable, and NOT editable.
    ...
    * objects: Only act on specified objects. If there are no objects specified, don't do anything.
    ...
    - Args:
        ...
        - query (q): Query mode flag
    """
@overload #Overload for selectKey in ['edit']
def selectKey([targetList]: [targetList], attribute: str = ..., float: floatrange = ..., index: int = ..., time: timerange = ..., edit: bool = ...) -> int:
    """selectKey is undoable, NOT queryable, and NOT editable.
    ...
    * objects: Only act on specified objects. If there are no objects specified, don't do anything.
    ...
    """
@overload #Overload for selectKey in ['edit']
def selectKey([targetList]: [targetList], at: str = ..., f: floatrange = ..., t: timerange = ..., e: bool = ...) -> int:
    """selectKey is undoable, NOT queryable, and NOT editable.
    ...
    * objects: Only act on specified objects. If there are no objects specified, don't do anything.
    ...
    """
@overload #Overload for selectKey in ['edit']
def selectKey([targetList]: [targetList], attribute: str = ..., at: str = ..., float: floatrange = ..., f: floatrange = ..., index: int = ..., time: timerange = ..., t: timerange = ..., edit: bool = ..., e: bool = ...) -> int:
    """selectKey is undoable, NOT queryable, and NOT editable.
