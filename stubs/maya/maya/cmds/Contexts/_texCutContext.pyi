...
def texCutContext(contextName: contextName, exists: bool = ..., history: bool = ..., image1: str = ..., image2: str = ..., image3: str = ..., name: str = ...) -> float | float | bool | float | float | str | bool | bool:
    ...
    """
@overload #Overload for texCutContext in ['create']
def texCutContext(contextName: contextName, ex: bool = ..., ch: bool = ..., i1: str = ..., i2: str = ..., i3: str = ..., n: str = ...) -> float | float | bool | float | float | str | bool | bool:
    """texCutContext is undoable, queryable, and editable.
    ...
    """
@overload #Overload for texCutContext in ['create']
def texCutContext(contextName: contextName, exists: bool = ..., ex: bool = ..., history: bool = ..., ch: bool = ..., image1: str = ..., i1: str = ..., image2: str = ..., i2: str = ..., image3: str = ..., i3: str = ..., name: str = ..., n: str = ...) -> float | float | bool | float | float | str | bool | bool:
    """texCutContext is undoable, queryable, and editable.
