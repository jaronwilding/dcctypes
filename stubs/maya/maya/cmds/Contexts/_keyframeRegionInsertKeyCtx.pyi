...
def keyframeRegionInsertKeyCtx(contextName: contextName, breakdown: bool = ..., exists: bool = ..., history: bool = ..., image1: str = ..., image2: str = ..., image3: str = ..., name: str = ...) -> str:
    ...
    """
@overload #Overload for keyframeRegionInsertKeyCtx in ['create']
def keyframeRegionInsertKeyCtx(contextName: contextName, bd: bool = ..., ex: bool = ..., ch: bool = ..., i1: str = ..., i2: str = ..., i3: str = ..., n: str = ...) -> str:
    """keyframeRegionInsertKeyCtx is undoable, queryable, and editable.
    ...
    """
@overload #Overload for keyframeRegionInsertKeyCtx in ['create']
def keyframeRegionInsertKeyCtx(contextName: contextName, breakdown: bool = ..., bd: bool = ..., exists: bool = ..., ex: bool = ..., history: bool = ..., ch: bool = ..., image1: str = ..., i1: str = ..., image2: str = ..., i2: str = ..., image3: str = ..., i3: str = ..., name: str = ..., n: str = ...) -> str:
    """keyframeRegionInsertKeyCtx is undoable, queryable, and editable.
