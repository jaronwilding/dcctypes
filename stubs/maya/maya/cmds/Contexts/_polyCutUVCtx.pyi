...
@overload #Overload for polyCutUVCtx in ['create']
def polyCutUVCtx(contextName: contextName, loopSpeed: int = ..., mapBordersColor: [float, float, float] = ..., showCheckerMap: bool = ..., showTextureBorders: bool = ..., showUVShellColoring: bool = ..., steadyStroke: bool = ..., steadyStrokeDistance: float = ..., symmetry: int = ...) -> bool | float:
    ...
    """
@overload #Overload for polyCutUVCtx in ['create']
def polyCutUVCtx(contextName: contextName, ls: int = ..., mbc: [float, float, float] = ..., scm: bool = ..., stb: bool = ..., ssc: bool = ..., ss: bool = ..., ssd: float = ..., sym: int = ...) -> bool | float:
    """polyCutUVCtx is undoable, queryable, and editable.
    ...
    """
@overload #Overload for polyCutUVCtx in ['create']
def polyCutUVCtx(contextName: contextName, loopSpeed: int = ..., ls: int = ..., mapBordersColor: [float, float, float] = ..., mbc: [float, float, float] = ..., showCheckerMap: bool = ..., scm: bool = ..., showTextureBorders: bool = ..., stb: bool = ..., showUVShellColoring: bool = ..., ssc: bool = ..., steadyStroke: bool = ..., ss: bool = ..., steadyStrokeDistance: float = ..., ssd: float = ..., symmetry: int = ..., sym: int = ...) -> bool | float:
    """polyCutUVCtx is undoable, queryable, and editable.
