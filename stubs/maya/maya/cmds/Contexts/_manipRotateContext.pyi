...
def manipRotateContext([object]: [object], alignAlong: [float, float, float] = ..., centerTrackball: bool = ..., exists: bool = ..., image1: str = ..., image2: str = ..., image3: str = ..., orientObject: str = ..., orientTowards: [float, float, float] = ..., postCommand: script = ..., postDragCommand: [script, string] = ..., preCommand: script = ..., preDragCommand: [script, string] = ..., snap: bool = ..., snapRelative: bool = ..., snapValue: float = ...) -> str:
    ...
    """
@overload #Overload for manipRotateContext in ['create']
def manipRotateContext([object]: [object], aa: [float, float, float] = ..., ctb: bool = ..., ex: bool = ..., i1: str = ..., i2: str = ..., i3: str = ..., oo: str = ..., ot: [float, float, float] = ..., psc: script = ..., pod: [script, string] = ..., prc: script = ..., prd: [script, string] = ..., s: bool = ..., sr: bool = ..., sv: float = ...) -> str:
    """manipRotateContext is undoable, queryable, and editable.
    ...
    """
@overload #Overload for manipRotateContext in ['create']
def manipRotateContext([object]: [object], alignAlong: [float, float, float] = ..., aa: [float, float, float] = ..., centerTrackball: bool = ..., ctb: bool = ..., exists: bool = ..., ex: bool = ..., image1: str = ..., i1: str = ..., image2: str = ..., i2: str = ..., image3: str = ..., i3: str = ..., orientObject: str = ..., oo: str = ..., orientTowards: [float, float, float] = ..., ot: [float, float, float] = ..., postCommand: script = ..., psc: script = ..., postDragCommand: [script, string] = ..., pod: [script, string] = ..., preCommand: script = ..., prc: script = ..., preDragCommand: [script, string] = ..., prd: [script, string] = ..., snap: bool = ..., s: bool = ..., snapRelative: bool = ..., sr: bool = ..., snapValue: float = ..., sv: float = ...) -> str:
    """manipRotateContext is undoable, queryable, and editable.
