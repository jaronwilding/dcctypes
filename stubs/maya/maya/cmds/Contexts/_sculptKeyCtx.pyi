...
def sculptKeyCtx(contextName: contextName, affectsTime: bool = ..., affectsTimeAll: str = ..., brushScaling: int = ..., editingRadius: bool = ..., editingStrength: bool = ..., exists: bool = ..., falloffCurve: str = ..., falloffCurveAll: str = ..., history: bool = ..., image1: str = ..., image2: str = ..., image3: str = ..., minRadius: float = ..., minStrength: float = ..., minStrengthAll: str = ..., mode: int = ..., modeMinStrength: [int, float] = ..., modeStrength: [int, float] = ..., name: str = ..., radius: float = ..., reset: bool = ..., strength: float = ..., strengthAll: str = ...) -> str:
    ...
    """
@overload #Overload for sculptKeyCtx in ['create']
def sculptKeyCtx(contextName: contextName, at: bool = ..., ata: str = ..., brs: int = ..., er: bool = ..., es: bool = ..., ex: bool = ..., fc: str = ..., fca: str = ..., ch: bool = ..., i1: str = ..., i2: str = ..., i3: str = ..., mr: float = ..., ms: float = ..., msa: str = ..., m: int = ..., mms: [int, float] = ..., mst: [int, float] = ..., n: str = ..., r: float = ..., rs: bool = ..., s: float = ..., sa: str = ...) -> str:
    """sculptKeyCtx is undoable, queryable, and editable.
    ...
    """
@overload #Overload for sculptKeyCtx in ['create']
def sculptKeyCtx(contextName: contextName, affectsTime: bool = ..., at: bool = ..., affectsTimeAll: str = ..., ata: str = ..., brushScaling: int = ..., brs: int = ..., editingRadius: bool = ..., er: bool = ..., editingStrength: bool = ..., es: bool = ..., exists: bool = ..., ex: bool = ..., falloffCurve: str = ..., fc: str = ..., falloffCurveAll: str = ..., fca: str = ..., history: bool = ..., ch: bool = ..., image1: str = ..., i1: str = ..., image2: str = ..., i2: str = ..., image3: str = ..., i3: str = ..., minRadius: float = ..., mr: float = ..., minStrength: float = ..., ms: float = ..., minStrengthAll: str = ..., msa: str = ..., mode: int = ..., m: int = ..., modeMinStrength: [int, float] = ..., mms: [int, float] = ..., modeStrength: [int, float] = ..., mst: [int, float] = ..., name: str = ..., n: str = ..., radius: float = ..., r: float = ..., reset: bool = ..., rs: bool = ..., strength: float = ..., s: float = ..., strengthAll: str = ..., sa: str = ...) -> str:
    """sculptKeyCtx is undoable, queryable, and editable.
...
def sculptKeyCtx(contextName: contextName, activeMode: int = ..., affectsTime: bool = ..., affectsTimeAll: str = ..., brushScaling: int = ..., editingRadius: bool = ..., editingStrength: bool = ..., falloffCurve: str = ..., falloffCurveAll: str = ..., image1: str = ..., image2: str = ..., image3: str = ..., minRadius: float = ..., minStrength: float = ..., minStrengthAll: str = ..., mode: int = ..., modeMinStrength: [int, float] = ..., modeStrength: [int, float] = ..., radius: float = ..., reset: bool = ..., strength: float = ..., strengthAll: str = ..., query: bool = ...) -> str:
    """sculptKeyCtx is undoable, queryable, and editable.
    ...
    """
@overload #Overload for sculptKeyCtx in ['query']
def sculptKeyCtx(contextName: contextName, am: int = ..., at: bool = ..., ata: str = ..., brs: int = ..., er: bool = ..., es: bool = ..., fc: str = ..., fca: str = ..., i1: str = ..., i2: str = ..., i3: str = ..., mr: float = ..., ms: float = ..., msa: str = ..., m: int = ..., mms: [int, float] = ..., mst: [int, float] = ..., r: float = ..., rs: bool = ..., s: float = ..., sa: str = ..., q: bool = ...) -> str:
    """sculptKeyCtx is undoable, queryable, and editable.
    ...
    """
@overload #Overload for sculptKeyCtx in ['query']
def sculptKeyCtx(contextName: contextName, activeMode: int = ..., am: int = ..., affectsTime: bool = ..., at: bool = ..., affectsTimeAll: str = ..., ata: str = ..., brushScaling: int = ..., brs: int = ..., editingRadius: bool = ..., er: bool = ..., editingStrength: bool = ..., es: bool = ..., falloffCurve: str = ..., fc: str = ..., falloffCurveAll: str = ..., fca: str = ..., image1: str = ..., i1: str = ..., image2: str = ..., i2: str = ..., image3: str = ..., i3: str = ..., minRadius: float = ..., mr: float = ..., minStrength: float = ..., ms: float = ..., minStrengthAll: str = ..., msa: str = ..., mode: int = ..., m: int = ..., modeMinStrength: [int, float] = ..., mms: [int, float] = ..., modeStrength: [int, float] = ..., mst: [int, float] = ..., radius: float = ..., r: float = ..., reset: bool = ..., rs: bool = ..., strength: float = ..., s: float = ..., strengthAll: str = ..., sa: str = ..., query: bool = ..., q: bool = ...) -> str:
    """sculptKeyCtx is undoable, queryable, and editable.
