...
def filterGaussianCtx(contextName: contextName, endTime: time = ..., exists: bool = ..., history: bool = ..., image1: str = ..., image2: str = ..., image3: str = ..., name: str = ..., sampleCount: int = ..., selectedKeys: bool = ..., startTime: time = ..., useQuaternion: bool = ..., width: time = ...) -> str:
    ...
    """
@overload #Overload for filterGaussianCtx in ['create']
def filterGaussianCtx(contextName: contextName, e: time = ..., ex: bool = ..., ch: bool = ..., i1: str = ..., i2: str = ..., i3: str = ..., n: str = ..., sc: int = ..., sk: bool = ..., s: time = ..., uq: bool = ..., w: time = ...) -> str:
    """filterGaussianCtx is undoable, queryable, and editable.
    ...
    """
@overload #Overload for filterGaussianCtx in ['create']
def filterGaussianCtx(contextName: contextName, endTime: time = ..., e: time = ..., exists: bool = ..., ex: bool = ..., history: bool = ..., ch: bool = ..., image1: str = ..., i1: str = ..., image2: str = ..., i2: str = ..., image3: str = ..., i3: str = ..., name: str = ..., n: str = ..., sampleCount: int = ..., sc: int = ..., selectedKeys: bool = ..., sk: bool = ..., startTime: time = ..., s: time = ..., useQuaternion: bool = ..., uq: bool = ..., width: time = ..., w: time = ...) -> str:
    """filterGaussianCtx is undoable, queryable, and editable.
