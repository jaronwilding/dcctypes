...
def scriptCtx(string: str, baseClassName: str = ..., cumulativeLists: bool = ..., enableRootSelection: bool = ..., escToQuit: bool = ..., exitUponCompletion: bool = ..., expandSelectionList: bool = ..., finalCommandScript: script = ..., forceAddSelect: bool = ..., ignoreInvalidItems: bool = ..., image1: str = ..., image2: str = ..., image3: str = ..., lastAutoComplete: bool = ..., setAllowExcessCount: bool = ..., setAutoComplete: bool = ..., setAutoToggleSelection: bool = ..., setDoneSelectionPrompt: str = ..., setNoSelectionHeadsUp: str = ..., setNoSelectionPrompt: str = ..., setSelectionCount: int = ..., setSelectionHeadsUp: str = ..., setSelectionPrompt: str = ..., showManipulators: bool = ..., title: str = ..., toolCursorType: str = ..., toolFinish: script = ..., toolStart: script = ..., totalSelectionSets: int = ..., edit: bool = ...) -> str:
    """scriptCtx is undoable, queryable, and editable.
    ...
    """
@overload #Overload for scriptCtx in ['edit']
def scriptCtx(string: str, bcn: str = ..., cls: bool = ..., ers: bool = ..., esc: bool = ..., euc: bool = ..., esl: bool = ..., fcs: script = ..., fas: bool = ..., iii: bool = ..., i1: str = ..., i2: str = ..., i3: str = ..., lac: bool = ..., sae: bool = ..., sac: bool = ..., sat: bool = ..., dsp: str = ..., snh: str = ..., snp: str = ..., ssc: int = ..., ssh: str = ..., ssp: str = ..., sm: bool = ..., t: str = ..., tct: str = ..., tf: script = ..., ts: script = ..., tss: int = ..., e: bool = ...) -> str:
    """scriptCtx is undoable, queryable, and editable.
    ...
    """
@overload #Overload for scriptCtx in ['edit']
def scriptCtx(string: str, baseClassName: str = ..., bcn: str = ..., cumulativeLists: bool = ..., cls: bool = ..., enableRootSelection: bool = ..., ers: bool = ..., escToQuit: bool = ..., esc: bool = ..., exitUponCompletion: bool = ..., euc: bool = ..., expandSelectionList: bool = ..., esl: bool = ..., finalCommandScript: script = ..., fcs: script = ..., forceAddSelect: bool = ..., fas: bool = ..., ignoreInvalidItems: bool = ..., iii: bool = ..., image1: str = ..., i1: str = ..., image2: str = ..., i2: str = ..., image3: str = ..., i3: str = ..., lastAutoComplete: bool = ..., lac: bool = ..., setAllowExcessCount: bool = ..., sae: bool = ..., setAutoComplete: bool = ..., sac: bool = ..., setAutoToggleSelection: bool = ..., sat: bool = ..., setDoneSelectionPrompt: str = ..., dsp: str = ..., setNoSelectionHeadsUp: str = ..., snh: str = ..., setNoSelectionPrompt: str = ..., snp: str = ..., setSelectionCount: int = ..., ssc: int = ..., setSelectionHeadsUp: str = ..., ssh: str = ..., setSelectionPrompt: str = ..., ssp: str = ..., showManipulators: bool = ..., sm: bool = ..., title: str = ..., t: str = ..., toolCursorType: str = ..., tct: str = ..., toolFinish: script = ..., tf: script = ..., toolStart: script = ..., ts: script = ..., totalSelectionSets: int = ..., tss: int = ..., edit: bool = ..., e: bool = ...) -> str:
    """scriptCtx is undoable, queryable, and editable.
