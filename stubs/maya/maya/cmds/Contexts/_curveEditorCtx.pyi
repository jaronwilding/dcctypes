...
def curveEditorCtx(exists: bool = ..., history: bool = ..., image1: str = ..., image2: str = ..., image3: str = ..., name: str = ..., relativeTangentSize: float = ...) -> str:
    ...
    """
@overload #Overload for curveEditorCtx in ['create']
def curveEditorCtx(ex: bool = ..., ch: bool = ..., i1: str = ..., i2: str = ..., i3: str = ..., n: str = ..., rts: float = ...) -> str:
    """curveEditorCtx is undoable, queryable, and editable.
    ...
    """
@overload #Overload for curveEditorCtx in ['create']
def curveEditorCtx(exists: bool = ..., ex: bool = ..., history: bool = ..., ch: bool = ..., image1: str = ..., i1: str = ..., image2: str = ..., i2: str = ..., image3: str = ..., i3: str = ..., name: str = ..., n: str = ..., relativeTangentSize: float = ..., rts: float = ...) -> str:
    """curveEditorCtx is undoable, queryable, and editable.
