...
def modelCurrentTimeCtx(contextName: contextName, exists: bool = ..., history: bool = ..., image1: str = ..., image2: str = ..., image3: str = ..., name: str = ...) -> str:
    ...
    """
@overload #Overload for modelCurrentTimeCtx in ['create']
def modelCurrentTimeCtx(contextName: contextName, ex: bool = ..., ch: bool = ..., i1: str = ..., i2: str = ..., i3: str = ..., n: str = ...) -> str:
    """modelCurrentTimeCtx is undoable, queryable, and editable.
    ...
    """
@overload #Overload for modelCurrentTimeCtx in ['create']
def modelCurrentTimeCtx(contextName: contextName, exists: bool = ..., ex: bool = ..., history: bool = ..., ch: bool = ..., image1: str = ..., i1: str = ..., image2: str = ..., i2: str = ..., image3: str = ..., i3: str = ..., name: str = ..., n: str = ...) -> str:
    """modelCurrentTimeCtx is undoable, queryable, and editable.
