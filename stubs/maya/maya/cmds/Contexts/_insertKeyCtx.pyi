...
def insertKeyCtx(contextName: contextName, breakdown: bool = ..., exists: bool = ..., history: bool = ..., image1: str = ..., image2: str = ..., image3: str = ..., name: str = ..., preserveTangent: bool = ...) -> str:
    ...
    """
@overload #Overload for insertKeyCtx in ['create']
def insertKeyCtx(contextName: contextName, bd: bool = ..., ex: bool = ..., ch: bool = ..., i1: str = ..., i2: str = ..., i3: str = ..., n: str = ..., pt: bool = ...) -> str:
    """insertKeyCtx is undoable, queryable, and editable.
    ...
    """
@overload #Overload for insertKeyCtx in ['create']
def insertKeyCtx(contextName: contextName, breakdown: bool = ..., bd: bool = ..., exists: bool = ..., ex: bool = ..., history: bool = ..., ch: bool = ..., image1: str = ..., i1: str = ..., image2: str = ..., i2: str = ..., image3: str = ..., i3: str = ..., name: str = ..., n: str = ..., preserveTangent: bool = ..., pt: bool = ...) -> str:
    """insertKeyCtx is undoable, queryable, and editable.
