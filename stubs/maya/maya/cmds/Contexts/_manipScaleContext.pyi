...
def manipScaleContext([object]: [object], alignAlong: [float, float, float] = ..., exists: bool = ..., image1: str = ..., image2: str = ..., image3: str = ..., orientObject: str = ..., orientTowards: [float, float, float] = ..., postCommand: script = ..., postDragCommand: [script, string] = ..., preCommand: script = ..., preDragCommand: [script, string] = ..., snap: bool = ..., snapRelative: bool = ..., snapValue: float = ..., useManipPivot: bool = ..., useObjectPivot: bool = ...) -> str:
    ...
    """
@overload #Overload for manipScaleContext in ['create']
def manipScaleContext([object]: [object], aa: [float, float, float] = ..., ex: bool = ..., i1: str = ..., i2: str = ..., i3: str = ..., oo: str = ..., ot: [float, float, float] = ..., psc: script = ..., pod: [script, string] = ..., prc: script = ..., prd: [script, string] = ..., s: bool = ..., sr: bool = ..., sv: float = ..., ump: bool = ..., uop: bool = ...) -> str:
    """manipScaleContext is undoable, queryable, and editable.
