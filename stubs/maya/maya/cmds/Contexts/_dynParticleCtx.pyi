...
def dynParticleCtx(string: str, exists: bool = ..., history: bool = ..., image1: str = ..., image2: str = ..., image3: str = ..., name: str = ...) -> None:
    ...
    """
@overload #Overload for dynParticleCtx in ['create']
def dynParticleCtx(string: str, ex: bool = ..., ch: bool = ..., i1: str = ..., i2: str = ..., i3: str = ..., n: str = ...) -> None:
    """dynParticleCtx is undoable, queryable, and editable.
    ...
    """
@overload #Overload for dynParticleCtx in ['create']
def dynParticleCtx(string: str, exists: bool = ..., ex: bool = ..., history: bool = ..., ch: bool = ..., image1: str = ..., i1: str = ..., image2: str = ..., i2: str = ..., image3: str = ..., i3: str = ..., name: str = ..., n: str = ...) -> None:
    """dynParticleCtx is undoable, queryable, and editable.
