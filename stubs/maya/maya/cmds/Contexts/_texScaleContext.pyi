"""Stub files for Contexts category in Maya commands, command: texScaleContext."""
...
def texScaleContext(editPivotMode: bool = ..., image1: str = ..., image2: str = ..., image3: str = ..., position: bool = ..., preventNegativeScale: bool = ..., snap: bool = ..., snapRelative: bool = ..., snapValue: float = ..., tweakMode: bool = ..., query: bool = ...) -> str:
    ...
    """
@overload #Overload for texScaleContext in ['query']
def texScaleContext(epm: bool = ..., i1: str = ..., i2: str = ..., i3: str = ..., p: bool = ..., pns: bool = ..., s: bool = ..., sr: bool = ..., sv: float = ..., twk: bool = ..., q: bool = ...) -> str:
    """texScaleContext is undoable, queryable, and editable.
    ...
    """
@overload #Overload for texScaleContext in ['query']
def texScaleContext(editPivotMode: bool = ..., epm: bool = ..., image1: str = ..., i1: str = ..., image2: str = ..., i2: str = ..., image3: str = ..., i3: str = ..., position: bool = ..., p: bool = ..., preventNegativeScale: bool = ..., pns: bool = ..., snap: bool = ..., s: bool = ..., snapRelative: bool = ..., sr: bool = ..., snapValue: float = ..., sv: float = ..., tweakMode: bool = ..., twk: bool = ..., query: bool = ..., q: bool = ...) -> str:
    """texScaleContext is undoable, queryable, and editable.
    ...
    - Args:
        ...
        - query (q): Query mode flag
    """
@overload #Overload for texScaleContext in ['edit']
def texScaleContext(image1: str = ..., image2: str = ..., image3: str = ..., preventNegativeScale: bool = ..., snap: bool = ..., snapRelative: bool = ..., snapValue: float = ..., tweakMode: bool = ..., edit: bool = ...) -> str:
    """texScaleContext is undoable, queryable, and editable.
    ...
    """
@overload #Overload for texScaleContext in ['edit']
def texScaleContext(i1: str = ..., i2: str = ..., i3: str = ..., pns: bool = ..., s: bool = ..., sr: bool = ..., sv: float = ..., twk: bool = ..., e: bool = ...) -> str:
    """texScaleContext is undoable, queryable, and editable.
    ...
    """
@overload #Overload for texScaleContext in ['edit']
def texScaleContext(image1: str = ..., i1: str = ..., image2: str = ..., i2: str = ..., image3: str = ..., i3: str = ..., preventNegativeScale: bool = ..., pns: bool = ..., snap: bool = ..., s: bool = ..., snapRelative: bool = ..., sr: bool = ..., snapValue: float = ..., sv: float = ..., tweakMode: bool = ..., twk: bool = ..., edit: bool = ..., e: bool = ...) -> str:
    """texScaleContext is undoable, queryable, and editable.
